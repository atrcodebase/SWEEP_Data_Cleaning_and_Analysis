...
remove_columns <- c("deviceid", "subscriberid", "simid", "devicephonenum", "username", "instance_time", "text_audit", "phone_call_log",
                    "collect_phone_app", "device_info", "full_name", "users", "pub_to_users", "num_calls", "call_num", "stop_at", "now_complete",
                    "userid", "calltime", "Supervisor_Name", "Supervisor_Name_label", "Call_Type", "Call_Type_label", "call_respondent",
                    "phone_response", "phone_response_label", "Not_reached_out_to_respondent", "Not_reached_out_to_respondent_label",
                    ...
                    "instanceID", "instanceName", "formdef_version", "resp_pn", "Surveyor_Gender", "Surveyor_ID", "resp_ver", "resp_ver_label",
                    "respondent_gender", "respondent_gender_label", "respondent_cbsg_member", "respondent_cbsg_member_label", "AA_Full"
                    )
...
backcheck <- select(backcheck, -all_of(remove_columns))
