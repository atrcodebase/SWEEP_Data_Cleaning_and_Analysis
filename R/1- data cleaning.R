...
remove_columns <- c("subscriberid", "simid", "devicephonenum", "instance_time", "text_audit",
                    ...
                    "Surveyor_Name_label", "District_New_label", "Province_New_label", 
                    "deviceid", "callback_time", "last_call_status", "call_num", "stop_at", "now_complete", "full_name", "call_date", "Surveyor_Name", "phone_response", "Reached_out_to_respondent",	"Not_reached_out_to_respondent",	"Is_the_target_respondent_living_in_this_hh", "Phone_passed_over", "Obtions_to_reach_out_to_respondent", "Obtions_to_reach_out_to_respondent_label", "callback_availability",
